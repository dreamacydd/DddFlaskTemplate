...
"""This is an example fake data seeder pulled straight from my
Hanmoto project.

Feel free to edit it or delete if you don't need it.

This is only used to test the application with some obvious
fake data.  It's not required to use the Flask app itself."""
